...
### [NEW] **The Shaggs** a band of three, each playing a different song (pt.1)
...
### [NEW] **The Shaggs** a band of three, each playing a different song (pt.2)
...
### [NEW] **Tiny Tim** is the most succesful outsider mucisian, but why? (pt. 1)
...
### [NEW] **Tiny Tim** is the most succesful outsider mucisian, but why? (pt. 2)
...
compmus_long_distance(
  ...
  geom_tile() +
  coord_equal() +
  labs(title="Silent Night",x = "Eilert Pilram", y = "Elvis Presley") +
  theme_minimal() +
